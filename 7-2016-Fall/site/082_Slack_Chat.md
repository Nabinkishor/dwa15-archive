...
Our class slack lives at <https://dwa15-fall2016.slack.com>.
...
### Invites
To join the class Slack, you will need to be invited. During the first week of classes I will send invites to all registered students.
...
## Public Channels
+ __#general__
This is the main channel for this course where you can discuss course material, ask questions, troubleshoot, etc.
+ __#lecture__
This room is for students watching the live lecture who wish to ask a question or to request a clarification. This room is *not* for general chatter during the lecture, as that is distracting for the students and TAs who are monitoring the room.
+ __#off-topic__
This channel is for chatter that is not necessarily course specific. It’s purpose is to facilitate community in the course, without overwhelming the course related rooms.


## Private Channels
Private channels are used for TA Group discussion where you communicate with your groupmates and TA. The private channels are named according to the TA's name (e.g. `dans_group`, `jennis_group`, etc.). Once groups are sorted out at the start of the semester, you'll be invited by your TA to join the appropriate group channel.
