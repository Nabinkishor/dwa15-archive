...
class PracticeController extends Controller
{
    ...
    */
    public function foobar() {
        echo '<form method="post" action="/foobar/99">'.csrf_field().'<input type="submit"></form>';
    }
    ...
    *
    */
    public function postFoobar(Request $request, $id) {
        dump($id); # <-- WORKS
    }
    ...
    /**
    * Example for Devon
    * Demonstates how to get data to JS
    */
