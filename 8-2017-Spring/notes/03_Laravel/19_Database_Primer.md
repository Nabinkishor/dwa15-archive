...
If MySQL is not running refer to these notes: [Debugging your local server](https://github.com/susanBuck/dwa15-spring2017-notes/blob/master/01_Servers_and_Git/02_Debugging_local_servers.md).
...
To understand the **MySQL data types** chosen for each field in this table, [visit this reference of common MySQL data types](https://github.com/susanBuck/dwa15-spring2017-notes/blob/master/03_Laravel/21_Common_MySQL_Data_Types.md).
